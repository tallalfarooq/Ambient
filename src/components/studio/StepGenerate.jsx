...
import { Sparkles, Loader2, RefreshCw, ThumbsUp, ThumbsDown, BookmarkCheck, Download, Share2 } from "lucide-react";
...
const buildPrompt = (data) => {
  ...
  return (
    `Interior design photograph, ${data.style} style, ${data.color_palette} color palette${dimStr}, ` +
