        ...
        <footer className="border-t border-white/6 py-8 px-6">
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-4">
              {/* Day 9.2 — Pinterest icon removed. Previously linked to
                  https://pinterest.com (the homepage of Pinterest, not an
                  Ambient Space profile) which read as a placeholder/dead
                  link. Re-add when an actual profile exists. */}
